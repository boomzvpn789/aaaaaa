...
show_system_info() {
    echo -e "${WHITE}ระบบปฏิบัติการ${NC}                : ${BOLD}Ubuntu 20.04.6 LTS${NC}"
    echo -e "${WHITE}เคอร์เนล${NC}                     : ${BOLD}5.4.0-192-generic${NC}"
    echo -e "${WHITE}RAM ใช้งาน${NC}                   : ${BOLD}11.76%${NC}"
    echo -e "${WHITE}โหลด CPU${NC}                    : ${BOLD}11.8%${NC}"
    echo -e "${WHITE}เวลาใช้งานเซิร์ฟเวอร์${NC}        : ${BOLD}up 2 minutes${NC}"
    echo -e "${WHITE}IP VPS${NC}                      : ${BOLD}103.230.121.56${NC}"
    echo -e "${WHITE}โดเมน${NC}                       : ${BOLD}th.nurul.cloud${NC}"
    echo -e "${WHITE}สถานะโดเมน${NC}                 : ${BOLD}ตลอดชีพ${NC}"
    echo -e "${WHITE}ชื่อผู้ใช้งาน${NC}                : ${BOLD}EKROMVPN SSH AIO${NC}"
}
