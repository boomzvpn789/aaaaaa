...
# domain random
CDN="https://raw.githubusercontent.com/boomzvpn789/aaaaaa/master/ssh"
cd /root
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/boomzvpn789/aaaaaa/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/boomzvpn789/aaaaaa/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/boomzvpn789/aaaaaa/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
